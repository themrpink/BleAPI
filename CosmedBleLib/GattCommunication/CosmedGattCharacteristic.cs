...
namespace CosmedBleLib.GattCommunication
{
    ...
    public class CosmedGattErrorFoundEventArgs : EventArgs
    {
        ...
        /// <param name="property">The GattReadClientCharacteristicConfigurationDescriptorResult.</param>
        ...
        /// </summary>
        /// <param name="exception">The catched exception</param>
        /// <param name="property">The characteristic properties.</param>
        /// <param name="result">The GattReadClientCharacteristicConfigurationDescriptorResult.</param>
    ...
    /// <summary>
    /// Represents a subscription result
    /// </summary>
    public class CosmedCharacteristicSubscriptionResult : ICommunicationResult
    {
        ...
        /// <summary>
        /// Gets the GattClientCharacteristicConfigurationDescriptorValue
        /// </summary>
        ...
        /// </summary>
        /// <param name="property">The characteristic properties.</param>
        /// <param name="status">The communication status</param>
        ...
        /// <param name="property">The characteristic properties.</param>
        /// <param name="status">The communication status</param>
        /// <param name="clientCharacteristicConfigurationDescriptor">GattClientCharacteristicConfigurationDescriptorValue</param>
        /// <param name="protocolError">The protocol error</param>
